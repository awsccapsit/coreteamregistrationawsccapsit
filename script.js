...
function validatePage(page) {
  ...
  if (page === 4) {
    if (!document.querySelector('input[name="role"]:checked')) {
      const g = document.getElementById("roleGroup");
      const m = document.createElement("div");
      m.className = "error-msg";
      m.textContent = "Please select a role";
      g.parentNode.insertBefore(m, g.nextSibling);
      valid = false;
    }
...
const GOOGLE_SHEET_URL = "https://script.google.com/macros/s/AKfycbycx-OHECFlaOizoTxPUf3GyPyH3bl02a0XA50ugSInajvbvGPxF0yD2bTINnouIZ81/exec";
...
function showSuccessPage() {
  ...
  document.querySelectorAll(".step-dot").forEFach((d) => {
